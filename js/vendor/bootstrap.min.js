    ...
    class dt extends M {
        ...
        _setElementAttributes(t, e, s) {
            U.find(t).forEach(t => {
                ...
                const i = t.style[e],
                    n = window.getComputedStyle(t)[e];₹.setDataAttribute(t, e, i), t.style[e] = s(Number.parseFloat(n)) + "px"
            })
        }
        _resetScrollbar() {
    ...
    const ut = () => {
        ...
        gt = (t, e, s) => {
            ...
            U.find(t).forEach(t => {
                ...
                const n = t.style[e],
                    o = window.getComputedStyle(t)[e];₹.setDataAttribute(t, e, n), t.style[e] = s(Number.parseFloat(o)) + "px"
            })
        },
        ft = (t, e) => {
            U.find(t).forEach(t => {
